...
tmp1 = parse_to_list('./vsi_er_with_ours.txt', 'Compression Ratio')
tmp2 = parse_to_list('./vsi_homo2.txt', 'Compression Ratio')
ours_comp_ratio = np.array([tmp1[i] * tmp2[i] for i in range(min(len(tmp1), len(tmp2)))])
ours_flops = parse_to_list('./vsi_ours_with_er_flops.txt', 'flops')
ours_flops = ours_flops / 1e12
ours_prefill = parse_to_list('./vsi_ours_with_er_prefill.txt', 'Prefill')
ours_decode = parse_to_list('./vsi_ours_with_er_decode.txt', 'Decode')
ours_kvcache = parse_to_list('./vsi_ours_with_er_kvcache.txt', 'kvcache')
...
er_comp_ratio = tmp1
er_flops = parse_to_list('./vsi_er_without_ours_flops.txt', 'flops')
er_flops = er_flops / 1e12
er_prefill = parse_to_list('./vsi_er_without_ours_prefill.txt', 'Prefill')
er_decode = parse_to_list('./vsi_er_without_ours_decode.txt', 'Decode')
er_kvcache = parse_to_list('./vsi_er_without_ours_kvcache.txt', 'kvcache')
...
static_comp_ratio = parse_to_list('./vsi_homo1.txt', 'Compression Ratio')
static_flops = parse_to_list('./vsi_static_flops.txt', 'flops')
static_flops = static_flops / 1e12
static_prefill = parse_to_list('./vsi_static_prefill.txt', 'Prefill')
static_decode = parse_to_list('./vsi_static_decode.txt', 'Decode')
static_kvcache = parse_to_list('./vsi_static_kvcache.txt', 'kvcache')
...
full_flops = parse_to_list('./vsi_full_flops.txt', 'flops')
full_flops = full_flops / 1e12
full_prefill = parse_to_list('./vsi_full_prefill.txt', 'Prefill')
full_decode = parse_to_list('./vsi_full_decode.txt', 'Decode')
full_kvcache = parse_to_list('./vsi_full_kvcache.txt', 'kvcache')
